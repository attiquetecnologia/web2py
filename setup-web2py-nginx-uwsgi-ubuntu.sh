...
apt-get -y install python3 build-essential python3-dev python3-virtualenv libxml2-dev python3-pip unzip 
virtualenv -p /usr/bin/python3.7 /opt/venv37
...
[Service]
ExecStart = /usr/local/bin/uwsgi --ini /etc/uwsgi/apps-available/web2py.ini
...
cron = 0 0 -1 -1 -1 /opt/venv37/bin/python /home/www-data/web2py/web2py.py -Q -S welcome -M -R scripts/sessions2trash.py -A -o
no-orphans = true
